...
def download_and_areas(icebergname, output_location, coord1 = 'lat', coord2 = 'lon', timeRange=None,layerName=None):
  '''Function to download all NASA satellite images of an iceberg recorded from BYU and find it's daily area from the images
     Args:
           ...
           layerName (string): for isolating bands, optional
      Returns:
  ...
  for image in os.listdir(directory):
      ...
      area = pixel_area(directory+image,layerName)
